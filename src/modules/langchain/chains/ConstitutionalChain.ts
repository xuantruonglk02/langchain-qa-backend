...
export class ConstitutionalChain extends ConstitutionalChainLangchain {
    constructor() {
        const inputPrompt = new PromptTemplate({
            template: `{question}`,
            inputVariables: ['question'],
        });
        const inputChain = new LLMChain({
            llm: openAIModel,
            prompt: inputPrompt,
        });
        ...
        const principle = new ConstitutionalPrinciple({
            ...
            critiqueRequest: 'The model must not talk about Hồ Chí Minh',
            revisionRequest: 'Rewrite the model\'s output to "I don\'t know"',
        });
        ...
        const critiqueChain = new LLMChain({
            llm: openAIModel,
            prompt: CRITIQUE_PROMPT,
        });
        const revisionChain = new LLMChain({
            llm: openAIModel,
